...
class V1beta2DeviceClaim(BaseModel):
    config: list[V1beta2DeviceClaimConfiguration] = Field(default=[])

    constraints: list[V1beta2DeviceConstraint] = Field(default=[])

    requests: list[V1beta2DeviceRequest] = Field(default=[])
