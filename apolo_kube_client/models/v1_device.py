...
class V1Device(BaseModel):
    ...
    attributes: dict[str, V1DeviceAttribute] = Field(default_factory=lambda: {})
    ...
    capacity: dict[str, V1DeviceCapacity] = Field(default_factory=lambda: {})
    ...
    taints: list[V1DeviceTaint] = Field(default_factory=lambda: [])
