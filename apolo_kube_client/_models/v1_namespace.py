...
class V1Namespace(ResourceModel):
    ...
    kubernetes_ref: ClassVar[Final[str]] = "io.k8s.api.core.v1.Namespace"
    ...
    spec: Annotated[
        ...
        Field(
            ...
            exclude_if=lambda v: v == V1NamespaceSpec(),
        ),
        BeforeValidator(_default_if_none(V1NamespaceSpec)),
    ] = V1NamespaceSpec()
    ...
    status: Annotated[
        ...
        Field(
            ...
            exclude_if=lambda v: v == V1NamespaceStatus(),
        ),
        BeforeValidator(_default_if_none(V1NamespaceStatus)),
    ] = V1NamespaceStatus()
